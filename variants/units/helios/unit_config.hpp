...
// Sensor offsets
const float GYR_X_OFFSET = -0.023;
const float GYR_Y_OFFSET =  0.002;
const float GYR_Z_OFFSET =  0.017;
const float ACC_X_OFFSET =  0.009;
const float ACC_Y_OFFSET = -0.009;
const float ACC_Z_OFFSET =  0.028;
